          ...
          <div className="admin-card p-6 sm:p-8 flex flex-col justify-between h-full gap-6 w-full">
            <div className="flex flex-col gap-6">
              ...
              <div>
                ...
                <div className="relative">
                  <span className="absolute left-3 top-3 text-text-secondary/70 pointer-events-none z-10 flex items-center justify-center">
                  ...
                  <textarea
                    ...
                    className="w-full rounded-xl border border-border bg-white pr-4 py-2.5 text-sm font-medium text-text placeholder:text-text-secondary/50 outline-none resize-none focus:border-primary transition-colors duration-200"
                    style={{ paddingLeft: '2.375rem' }}
                  />
                </div>
              </div>
